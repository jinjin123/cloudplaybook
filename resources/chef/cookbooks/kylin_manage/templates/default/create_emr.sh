...
--instance-groups '[{"InstanceCount":2,"InstanceGroupType":"CORE","InstanceType":"d2.xlarge","Name":"Core instance group - 2"},{"InstanceCount":1,"InstanceGroupType":"MASTER","InstanceType":"r3.xlarge","Name":"Master instance group - 1"}]' \
