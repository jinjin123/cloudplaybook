...
template "#{node[:memcacheex][:appdir]}/sites/default/drupal.d/03memcache.settings.php" do
	source "03memcache.settings.php.erb"
	mode 0644
	owner "root"
	group "root"
end
...
#        not_if "cat #{node[:memcacheex][:appdir]}/sites/default/settings.php | grep 'autoslave.settings.php' "
#        cwd '/root'
#end
